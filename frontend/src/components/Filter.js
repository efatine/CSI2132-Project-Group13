...
export default function Filter(props) {
    ...
    return (
        <div className='filter container mt-[-110px]' ref={componentRef}>
            <div className='area w-1/4 mr-[4%]'>
                <span className='svg'>
                ...
                {/* <Input style={{
                        width: '100%',
                    }}  placeholder="Where do you want to visit" value={area}/> */}
                <Select
                    style={{
                        width: '100%',
                    }}
            ...
            <div className='numberPeople w-1/3'>
                <span className='svg'>
                ...
                <div className='people'>
                    <p className='title' onClick={() => { setSelPeople(!selPeople) }}> <span>{adultValue}</span> {adultValue>1 ? 'adults' : 'adult'} <span>{childValue}</span> children <span>{roomValue}</span> {roomValue>1 ? 'rooms' : 'room'} </p>
            ...
            <div className='submit'>
                <Button type="primary" onClick={submit} className='submitBtn bg-[#1677ff]' >
                    Search
                </Button>
            </div>
        </div>
